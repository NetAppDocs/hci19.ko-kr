...
스토리지 클러스터가 Element 12.3.1 에 있고 VVol 기능이 활성화된 경우 Element 소프트웨어 12.3.2 로 업그레이드하는 것이 좋습니다.
...
* 를 클릭합니다 <<Element 12.3.1>> NetApp Element 12.3.1의 새로운 기능 및 업데이트에 대해 설명합니다.
