...
설치 후 새 자산 또는 컴퓨팅 노드(및 BMC 자산)를 수동으로 추가해야 하는 경우 에서 생성한 새 HCC 사용자 계정을 사용하십시오 <<Set up a new user account in vCenter>>. 자세한 내용은 을 참조하십시오 link:task_mnode_add_assets.html["컴퓨팅 및 컨트롤러 자산을 관리 노드에 추가합니다"].
