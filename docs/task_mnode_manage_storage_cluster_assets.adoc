...
.무엇을 &#8217;필요로 할거야
* 을 복사했습니다  the installation ID and cluster ID of a storage cluster asset,스토리지 클러스터 ID 및 설치 ID입니다 추가할 모든 스토리지 클러스터의 경우
...
NOTE: 의 단계를 따랐는지 확인합니다  the installation ID and cluster ID of a storage cluster asset 계속하기 전에.
