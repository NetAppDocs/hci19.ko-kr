...
NOTE: NetApp 하이브리드 클라우드 제어 UI를 사용하여 H300E/H500E/H700E 컴퓨팅 노드에서 컴퓨팅 펌웨어를 업그레이드하는 것은 더 이상 지원되지 않습니다. 업그레이드하려면 를 사용해야 합니다 ,USB 드라이브 또는 을 누릅니다 ,BMC UI 컴퓨팅 펌웨어 번들을 마운트합니다.
